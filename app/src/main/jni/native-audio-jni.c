...
void Java_com_example_novas_myndk_Audio_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_example_novas_myndk_Audio_createBufferQueueAudioPlayer(JNIEnv* env,
        jclass clazz)
{
    SLresult result;
...
void Java_com_example_novas_myndk_Audio_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
jboolean Java_com_example_novas_myndk_Audio_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
    switch (which) {
    case 0:     // CLIP_NONE
